    ...
    <footer className="bg-[#f8f4db] shadow-md py-6">
      <div className="max-w-[1280px] mx-auto px-4 flex justify-between items-center relative">
        ...
        <div className="max-w-xs">
          ...
          <p>
            A legjobb könyvek egy helyen. Klasszikusok, újdonságok és akciók — minden olvasónak!
          </p>
        </div>
        ...
        <div>
            ...
            <ul className="space-y-1">
                <li><Link to="/kapcsolat" className="hover:underline">Kapcsolat</Link></li>
                <li><Link to="/gyik" className="hover:underline">GYIK</Link></li>
                <li><Link to="/adatvedelem" className="hover:underline">Adatvédelem</Link></li>
                <li><Link to="/aszf" className="hover:underline">ÁSZF</Link></li>
             </ul>
        </div>
