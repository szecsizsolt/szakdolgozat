      ...
      <div className="flex flex-col md:flex-row items-start gap-8">
        ...
        <div className="flex-1 space-y-6">
          <div>
            ...
            {book.narrator && (
              <p className="text-sm text-gray-500">Narrátor: {book.narrator}</p>
            )}
            {book.duration && (
              <p className="text-sm text-gray-500">Hossz: {book.duration} perc</p>
            )}
          </div>
