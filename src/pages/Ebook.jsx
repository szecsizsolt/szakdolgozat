...
export default function Ebook() {
  ...
  return (
    <div className={`flex flex-col items-center min-h-screen p-6 transition-colors ${
      darkMode ? 'bg-gray-900 text-white' : 'bg-[#fefce8] text-gray-900'
    }`}>

      {/* Könyv címe */}
    <h1
      className={`text-4xl font-bold text-center py-5 px-10 rounded mb-8 w-full max-w-7xl transition-colors
        ${darkMode ? 'bg-gray-800 text-white' : 'bg-yellow-300 text-gray-900'}`}
    >
      {book.title}
    </h1>
      ...
      >
        {/* Extra gombok */}
        <div className="sticky top-4 right-4 self-end z-20">
          <button
        ...
        {/* Szöveg */}
        {/* Szöveg doboz - automatikus szélességgel */}
      <div className="h-max flex justify-center w-full overflow-visible">
